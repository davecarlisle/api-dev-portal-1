...
<Jumbotron>
  ...
  <H1>HPE Digital Subscription Management</H1>
  <H2>Your entry point into HPE's edge-to-cloud platform API's</H2> 
  ...
  <img src="./images/gremlinrockin.png" alt="Grommet rocks!" />
</Jumbotron>
<Box my={25}>
  <SectionHeader>
    Start your <Emphasis> digital enablement </Emphasis> with HPE's APIs today!
  </SectionHeader>
